...
function HyperSwitch(options, req, parOptions) {
    if (options && options.constructor === HyperSwitch) {
        ...
        this.ctx = Object.assign({}, par.ctx);
    } else {
        // Brand new instance
...
HyperSwitch.prototype._createFilteredHandler = function(filters, handler, specInfo) {
    var filterIdx = 0;
...
HyperSwitch.prototype.request = function(req, options) {
    ...
    return this._createFilteredHandler(
        this._recursionDepth === 0 ? this._requestFilters : this._subRequestFilters,
        function(hyper, req) {
...
HyperSwitch.prototype._request = function(req, options) {
    ...
    if (handler) {
        ...
        var reqHandler = childHyperSwitch._createFilteredHandler(match.filters, handler, {
...
methods.forEach(function(method) {
    HyperSwitch.prototype[method] = function(uri, req) {
        return this.request(makeRequest(uri, req, method));
    };
});
