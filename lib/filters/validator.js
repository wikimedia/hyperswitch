...
class Validator {
    constructor(parameters, definitions) {
        ...
        const bodyParams = parameters.filter((p) => { return p.in === 'body'; });
 ...
 * @private
 */
Validator.prototype._convertToJsonSchema = (parameters) => {
    const schema = {
        type: 'object',
        properties: {}
    };
 ...
 * @private
 */
Validator.prototype._createTypeCoercionFunc = (parameters) => {
    let code = '';
    parameters.forEach((param) => {
